...
export type ZeroDevPaymasterRpcSchema = [
    {
        ...
        Parameters: [
            {
                chainId: number;
                userOp: PartialBy<UserOperationWithBigIntAsHex, "callGasLimit" | "preVerificationGas" | "verificationGasLimit" | "paymasterAndData">;
...
export type KernelValidator<Name extends string = string> = LocalAccount<Name> & {
    ...
    getDummySignature(userOperation: UserOperation, pluginEnableSignature?: Hex): Promise<Hex>;
    signUserOperation: (userOperation: UserOperation, pluginEnableSignature?: Hex) => Promise<Hex>;
