...
import { concat, concatHex, hexToBigInt, pad, toFunctionSelector, toHex, zeroAddress } from "viem";
...
export async function toKernelPluginManager(client, { sudo, regular, pluginEnableSignature, validatorInitData, executorData = {
    executor: zeroAddress,
    selector: toFunctionSelector("execute(address, uint256, bytes, uint8)")
