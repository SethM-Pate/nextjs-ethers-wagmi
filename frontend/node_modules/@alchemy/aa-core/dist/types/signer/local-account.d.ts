import { type HDAccount, type Hex, type PrivateKeyAccount } from "viem";
import type { SignTypedDataParams } from "../account/types.js";
import type { SmartAccountSigner } from "./types.js";
export declare class LocalAccountSigner<T extends HDAccount | PrivateKeyAccount> implements SmartAccountSigner {
    private owner;
    constructor(owner: T);
