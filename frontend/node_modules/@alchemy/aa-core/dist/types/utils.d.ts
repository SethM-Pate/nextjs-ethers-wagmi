 ...
 */
export declare const asyncPipe: <T>(...fns: ((x: T) => Promise<T>)[]) => (x: T) => Promise<T>;
type Deferrable<T> = {
 ...
 */
export declare function getUserOperationHash(request: UserOperationRequest, entryPointAddress: Address, chainId: bigint): string;
