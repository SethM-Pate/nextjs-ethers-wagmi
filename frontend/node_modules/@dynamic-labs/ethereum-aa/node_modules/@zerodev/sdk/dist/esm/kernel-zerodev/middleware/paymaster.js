...
export const withZeroDevPaymasterAndData = (provider, paymasterConfig) => {
    provider.withPaymasterMiddleware(zeroDevPaymasterAndDataMiddleware(provider, paymasterConfig));
    return provider;
};
export const zeroDevPaymasterAndDataMiddleware = (provider, paymasterConfig) => {
    return {
