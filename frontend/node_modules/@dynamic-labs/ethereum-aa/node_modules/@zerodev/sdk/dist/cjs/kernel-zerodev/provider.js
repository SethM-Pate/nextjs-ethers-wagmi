...
const gas_estimator_js_1 = require("./middleware/gas-estimator.js");
...
class ZeroDevProvider extends aa_core_1.SmartAccountProvider {
    constructor({ projectId, chain, entryPointAddress = constants_js_1.ENTRYPOINT_ADDRESS, rpcUrl, bundlerRpcUrl = constants_js_1.BUNDLER_URL, account, bundlerProvider, opts, }) {
        ...
        super(rpcClient, entryPointAddress, _chain, account, {
            ...
            minPriorityFeePerBid: opts?.minPriorityFeePerBid ??
                constants_js_1.minPriorityFeePerBidDefaults.get(_chain.id),
        });
            ...
            value: async (data, overrides, operation = Operation.Call) => {
                ...
                if (Array.isArray(data)) {
                    if (operation === Operation.Call) {
                        ...
                        throw errors_js_1.InvalidOperation;
                    }
                }
                else if ((0, account_js_1.isKernelAccount)(this.account)) {
        ...
        Object.defineProperty(this, "_runMiddlewareStack", {
            ...
            value: async (uo, overrides) => {
                const result = await (0, aa_core_1.asyncPipe)(this.dummyPaymasterDataMiddleware, this.feeDataGetter, this.paymasterDataMiddleware, this.gasEstimator, this.customMiddleware ?? aa_core_1.noOpMiddleware, async (struct) => ({ ...struct, ...overrides }))(uo);
                return (0, aa_core_1.deepHexlify)(await (0, aa_core_1.resolveProperties)(result));
            }
        });
        Object.defineProperty(this, "sendUserOperation", {
            ...
            value: async (data, overrides, operation = Operation.Call) => {
                ...
                do {
                    uoStruct = await (0, aa_core_1.asyncPipe)(this.dummyPaymasterDataMiddleware, this.feeDataGetter, this.paymasterDataMiddleware, this.gasEstimator, this.customMiddleware ?? aa_core_1.noOpMiddleware, async (struct) => ({ ...struct, ...overrides }))({
                        initCode,
                        sender: this.getAddress(),
                        nonce,
                        callData,
                    ...
                    request = (0, aa_core_1.deepHexlify)(await (0, aa_core_1.resolveProperties)(uoStruct));
                    if (!(0, ERC4337_utils_js_1.isValidRequest)(request)) {
        ...
        this.sendTxMaxRetries =
            opts?.sendTxMaxRetries ?? constants_js_1.DEFAULT_SEND_TX_MAX_RETRIES;
        this.sendTxRetryIntervalMs =
            opts?.sendTxRetryIntervalMs ?? constants_js_1.DEFAULT_SEND_TX_RETRY_INTERVAL_MS;
        (0, gas_estimator_js_1.withZeroDevGasEstimator)(this);
    }
    ...
    withZeroDevPaymasterAndData(config) {
        ...
        return (0, paymaster_js_1.withZeroDevPaymasterAndData)(this, config);
    }
}
