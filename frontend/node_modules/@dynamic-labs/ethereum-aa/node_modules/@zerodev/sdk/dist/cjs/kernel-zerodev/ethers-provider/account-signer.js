...
exports.ZeroDevAccountSigner = void 0;
...
class ZeroDevAccountSigner extends abstract_signer_1.Signer {
    ...
    _signTypedData(domain, types, value) {
        ...
        const params = hash_1._TypedDataEncoder.getPayload(domain, types, value);
        if (params.types) {
            delete params.types["EIP712Domain"];
        }
...
exports.ZeroDevAccountSigner = ZeroDevAccountSigner;
