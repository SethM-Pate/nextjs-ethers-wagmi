import { type AbiParameter, type AbiParameterKind, type AbiParameterToPrimitiveType, type AbiFunction, type ExtractAbiFunction } from "abitype";
import { type Pretty } from "abitype/src/types.js";
import type { ECDSAValidator, ECDSAValidatorParams } from "./ecdsa-validator.js";
import type { ERC165SessionKeyValidator, ERC165SessionKeyValidatorParams } from "./erc165-session-key-validator.js";
import type { KillSwitchValidator, KillSwitchValidatorParams } from "./kill-switch-validator.js";
import type { RecoveryValidator, RecoveryValidatorParams } from "./recovery-validator.js";
import type { SessionKeyValidator, SessionKeyValidatorParams, ParamRules, Permission, SessionKeyData, SessionKeyParams, ParamOperator } from "./session-key-validator.js";
import type { Abi, InferFunctionName, Narrow } from "viem";
export type SupportedValidators = "ECDSA" | "KILL_SWITCH" | "ERC165_SESSION_KEY" | "SESSION_KEY" | "RECOVERY";
...
export type GeneratePermissionFromArgsParameters<TAbi extends Abi | readonly unknown[], TFunctionName extends string | undefined = string, _FunctionName = TAbi extends Abi ? InferFunctionName<TAbi, TFunctionName> : never> = Pick<Permission, "target" | "valueLimit" | "operation"> & {
