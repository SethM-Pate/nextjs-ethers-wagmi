...
import { concat, concatHex, encodeFunctionData, getContract, keccak256, pad, toBytes, toHex, } from "viem";
...
export class KillSwitchValidator extends KernelBaseValidator {
    ...
    async signUserOp(userOp) {
        ...
        const extendedHash = keccak256(concat([pad(toHex(pausedUntil), { size: 6 }), hash]));
