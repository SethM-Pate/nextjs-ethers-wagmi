...
const resolveNetworkValidationMode = ({ enableForcedNetworkValidation, networkValidationMode, bridgeChains, }) => {
    if (networkValidationMode) {
        return networkValidationMode;
    }
    if (enableForcedNetworkValidation || Boolean(bridgeChains)) {
        return 'always';
    }
    return 'sign-in';
};
...
export { getDeepLinkPreference, getInitialView, initExpirationTime, isAuthTokenExpired, isDynamicContextSessionSettingExpired, isWagmiSessionSettingExpired, resolveNetworkValidationMode, sdkSettingsTimeout, setDynamicContextSessionSettings, setWagmiSessionSettings };
