...
export declare const getInitialView: ({ connectedWallets, isBridgeFlow, bridgeOnboardingCompleted, isAuthenticated, isMultiWalletEnabled, }: {
...
export declare const resolveNetworkValidationMode: ({ enableForcedNetworkValidation, networkValidationMode, bridgeChains, }: {
    enableForcedNetworkValidation: boolean | undefined;
