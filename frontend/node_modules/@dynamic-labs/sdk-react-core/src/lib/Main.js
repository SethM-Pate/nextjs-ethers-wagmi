...
import './context/ConnectWithEmailOtpContext/connectWithEmailOtpContext.js';
import './context/ConnectWithEmailOtpContext/constants.js';
...
const Main = () => {
    ...
    useEffect(() => {
        const newToWeb3WalletKey = LocalStorage.getFromLS(NEWTOWEB3_WALLET_EXTENSION_FLAG_KEY);
