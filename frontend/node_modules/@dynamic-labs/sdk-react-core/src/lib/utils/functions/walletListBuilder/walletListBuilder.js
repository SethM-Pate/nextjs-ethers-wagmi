...
const sortedInputList = (inputList) => {
    ...
    inputList.forEach((wallet) => {
        if (PRIORITY_WALLET_LIST.includes(wallet.key)) {
...
const walletListBuilder = ({ authMode, connectedWallets, multiWallet, numberOfWalletsToShow, inputList, isWalletConnectList, lastUsedWalletKey, signWithEmailWalletName, searchFilter, walletsFilter, loginWithEmail, groupWallets, walletBook, showMoreWalletsWithFilter, }) => {
...
const KEEP_WALLETS_NAME_LIST = ['wallet connect'];
...
export { PRIORITY_WALLET_LIST, SIGN_IN_WITH_EMAIL_WALLET_NAME, calculateWalletOffsetBasedOnInstalledAndLastUsedWallets, walletListBuilder };
