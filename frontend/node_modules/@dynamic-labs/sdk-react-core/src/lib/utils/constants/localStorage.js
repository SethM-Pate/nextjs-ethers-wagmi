...
const NETWORKS_STORAGE_KEY = 'dynamic_networks';
const NONCE_STORAGE_KEY = 'dynamic_nonce';
const PRIMARY_WALLET_ID = 'dynamic_primary_wallet_id';
const PROJECT_SETTINGS_STORAGE_KEY = 'dynamic_project_settings';
...
const AUTH_MODE = 'dynamic_auth_mode';
...
export { AUTH_MODE, AUTH_TOKEN, AUTH_USER, BRIDGE_ONBOARDING_COMPLETED, CONNECTED_WALLETS_INFO, CONNECTED_WALLET_NAME_SERVICE, DYNAMIC_CONTEXT_LAST_SESSION_SETTINGS, EMBEDDED_WALLET_SECURE_BANNER, EMBEDDED_WALLET_SESSION_SETTINGS, LAST_USED_WALLET, NETWORKS_STORAGE_KEY, NEWTOWEB3_WALLET_EXTENSION_FLAG_KEY, NONCE_STORAGE_KEY, PRIMARY_WALLET_ID, PROJECT_SETTINGS_STORAGE_KEY, WAGMI_LAST_SESSION_SETTINGS, WALLET_PICKER_SEARCH_KEY };
