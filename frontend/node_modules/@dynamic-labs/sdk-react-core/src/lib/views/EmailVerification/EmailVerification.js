...
const EmailVerification = () => {
    ...
    useOnUnmount(() => {
        if (!callCallbackOnUnmount.current)
            return;
        dynamicEvents.emit('emailVerificationResult', isValidatedRef.current, email !== null && email !== void 0 ? email : '');
    });
    useEffectOnce(() => {
    ...
    const isLoginView = view.type === 'login-with-email-verification';
