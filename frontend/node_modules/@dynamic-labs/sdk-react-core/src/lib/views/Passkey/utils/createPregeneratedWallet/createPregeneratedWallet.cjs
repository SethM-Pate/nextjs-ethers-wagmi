...
const createPregeneratedWallet = (_a) => _tslib.__awaiter(void 0, [_a], void 0, function* ({ user, walletConnector, environmentId, authToken, chains, }) {
    if (!authToken) {
    ...
    const signersResponse = yield api.createTurnkeyEmbeddedWallet({
        chains,
        environmentId,
        userJwt: authToken,
    });
    ...
    const embeddedWalletVerifiedCredential = findEmbeddedWalletFromVerifiedCredentials.findEmbeddedWalletFromVerifiedCredentials(jwt, primaryChain);
