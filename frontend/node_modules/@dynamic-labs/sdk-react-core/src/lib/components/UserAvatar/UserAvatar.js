...
const UserAvatar = ({ user, containerClassName, renderWithFallback = true, }) => {
    ...
    if (!source && !renderWithFallback)
        return null;
    return (jsx("div", { className: classNames('user-profile-social-account__connected-avatar', containerClassName), children: jsx(Image, { src: source, alt: 'User avatar', dataTestId: 'user-avatar', fallback: jsx(UserProfileIcon, {}) }) }));
};
