...
const UserAvatar = ({ user, containerClassName, renderWithFallback = true, }) => {
    ...
    if (!source && !renderWithFallback)
        return null;
    return (jsxRuntime.jsx("div", { className: classNames.classNames('user-profile-social-account__connected-avatar', containerClassName), children: jsxRuntime.jsx(Image.Image, { src: source, alt: 'User avatar', dataTestId: 'user-avatar', fallback: jsxRuntime.jsx(iconic.UserProfileIcon, {}) }) }));
};
