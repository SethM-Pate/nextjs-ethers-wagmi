...
export declare const DynamicWalletSettingsViews: readonly ["wallet-settings"];
export type DynamicWalletSettingsType = typeof DynamicWalletSettingsViews[number];
...
export type DynamicWidgetViews = 'wallets' | 'profile' | 'edit-profile' | DynamicTransactionsWidgetViewsType | DynamicPasskeyWidgetViewsType | DynamicWalletSettingsType;
