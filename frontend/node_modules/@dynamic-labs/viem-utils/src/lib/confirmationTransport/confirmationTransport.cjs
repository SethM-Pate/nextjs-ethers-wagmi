...
const confirmationTransport = ({ transport, walletUiUtils, getAccounts, onPersonalSign, onSendTransaction, onSignTypedData, provider, }) => interceptTransport.interceptTransport({
    getAccounts,
