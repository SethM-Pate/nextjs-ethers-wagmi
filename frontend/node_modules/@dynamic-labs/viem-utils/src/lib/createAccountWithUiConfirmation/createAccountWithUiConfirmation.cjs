...
const createAccountWithUiConfirmation = ({ address, account, provider, walletUiUtils, }) => accounts.toAccount({
    address,
    ...
    signTransaction: (...args) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        return walletUiUtils.sendTransaction({
            handler: () => _tslib.__awaiter(void 0, void 0, void 0, function* () { return (yield account()).signTransaction(...args); }),
            provider,
            transaction: args[0],
        });
    }),
