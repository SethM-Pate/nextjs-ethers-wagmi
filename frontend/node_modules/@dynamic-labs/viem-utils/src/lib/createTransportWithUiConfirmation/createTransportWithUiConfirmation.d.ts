 ...
 */
export declare const createTransportWithUiConfirmation: ({ walletUiUtils, publicClient, transport, }: Props) => import("viem").CustomTransport;
export declare const convertTransactionGasPriceToHex: ({ maxFeePerGas, maxPriorityFeePerGas, ...transaction }: TransactionRequest) => TransactionRequest;
export {};
