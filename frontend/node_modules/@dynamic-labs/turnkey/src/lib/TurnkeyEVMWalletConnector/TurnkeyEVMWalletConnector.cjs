...
class TurnkeyEVMWalletConnector extends TurnkeyWalletConnectorBase.TurnkeyWalletConnectorBase {
    ...
    setVerifiedCredentials(verifiedCredentials) {
        const turnkeyVerifiedCredential = findTurnkeyVerifiedCredential.findTurnkeyVerifiedCredential(verifiedCredentials, 'eip155');
    ...
    getAccount() {
        return _tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            if ((this.getAuthenticatorHandler().recoveryType === 'passkey' &&
                ((_a = this.__turnkeyClient) === null || _a === void 0 ? void 0 : _a.stamper) instanceof iframeStamper.IframeStamper) ||
                (this.getAuthenticatorHandler().recoveryType === 'email' &&
                    ((_b = this.__turnkeyClient) === null || _b === void 0 ? void 0 : _b.stamper) instanceof webauthnStamper.WebauthnStamper) ||
