...
class TurnkeySolanaWalletConnector extends TurnkeyWalletConnectorBase.TurnkeyWalletConnectorBase {
        ...
        (_a = this.chainRpcProviders) === null || _a === void 0 ? void 0 : _a.registerChainProviders(rpcProviders.ProviderChain.SOLANA, (config) => {
            ...
            if (config === null || config === void 0 ? void 0 : config.solana) {
                rpcProviders.solana = config.solana.map((network) => {
                    ...
                    const connection = createSolanaConnection.createSolanaConnection(rpcUrl);
                    return {
    ...
    setVerifiedCredentials(verifiedCredentials) {
        const turnkeyVerifiedCredential = findTurnkeyVerifiedCredential.findTurnkeyVerifiedCredential(verifiedCredentials, rpcProviders.ProviderChain.SOLANA);
    ...
    signAndSendTransaction(_a) {
        return _tslib.__awaiter(this, arguments, void 0, function* ({ transaction, }) {
            ...
            const sentTransaction = yield web3_js.sendAndConfirmRawTransaction(connectionClient, signedTransaction, {
